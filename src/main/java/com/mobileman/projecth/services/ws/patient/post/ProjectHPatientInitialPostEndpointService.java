 ...
 * 
 */
public interface ProjectHPatientInitialPostEndpointService {
     ...
     * 
     */
	public final static String POST_PATIENT_INITIAL_REQUEST = "ProjectHPostInitialRequest";

	/**
	 * @param data
	 * @return result of processed patient first post
	 * @throws Exception
	 */
	ProjectHPostInitialResponse postInitialPatientData(ProjectHPostInitialRequest data)
			throws Exception;
}
